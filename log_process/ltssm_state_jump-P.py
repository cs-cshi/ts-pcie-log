...
def extract_ltssm_info(log_path, start_str, end_str):
    ...
    total_eye_height_phase23_value = []
    current_eye_height_phase23_value = []

    total_eye_height_l0_value = []
    current_eye_height_l0_value = []
    ...
    with (open(log_path, 'r', encoding="utf-8", errors='ignore') as file):
        ...
        for line in log_lines:
            ...
            if start_flag:
                line = line.strip()
                if "print all or just histogram(0:all, 1:hist)" in line and current_histogram_data2_height:
                    current_ltssm_group.append(" ")
                    current_0x20560.append(" ")
                    current_0x10198.append(" ")
                    current_gen5_preset.append(" ")
                    current_speed.append(" ")
                    current_ltssm.append(" ")
                    current_ltssm_st_value.append(" ")
                    current_histogram_data.append(" ")
                    current_eq_obj_value.append(" ")
                    current_eq_obj_tap4_value.append(" ")
                    current_eq_obj_tap5_value.append(" ")
                    current_eq_obj_tap6_value.append(" ")
                    current_eq_obj_ffe_taps_value.append(" ")
                    current_eye_height_value.append(" ")
                    current_adc_os_cal_dig_cor_gen_value.append(" ")
                    current_adc_os_cal_actl_gen_value.append(" ")
                    current_take_it_out_value.append(" ")
                    current_take_it_out_early_value.append(" ")
                    current_eye_height_phase23_value.append(" ")
                    current_eye_height_l0_value.append(" ")
                    current_histogram_data2_height.append(" ")

                if "ltssm state is:" in line:
                    current_ltssm_group.append(line.split(":")[-1])
                elif "ltssm state track is:" in line:
                    current_ltssm_group.append(line.split(":")[-1])
                elif "0x20560" in line:
                    current_0x20560.append(line)
                elif "0x10198" in line:
                    current_0x10198.append(line)
                elif "[0x95]" in line:
                    current_gen5_preset.append(line)
                elif "current speed:GEN" in line:
                    current_speed.append(line)
                elif "current ltssm state(L0:0x10)" in line:
                    current_ltssm.append(line)
                ...
                elif "eye height phase23 value" in line:
                    current_eye_height_phase23_value.append(line)
                elif "eye height l0 value" in line:
                    current_eye_height_l0_value.append(line)
            ...
            if end_str in line:
                ...
                if current_0x10198:
                    total_0x10198.append(current_0x10198.copy())

                if current_gen5_preset:
                    total_gen5_preset.append(current_gen5_preset.copy())

                if current_speed:
                    total_speed.append(current_speed.copy())

                if current_ltssm:
                    total_ltssm.append(current_ltssm.copy())
                ...
                if current_eye_height_phase23_value:
                    total_eye_height_phase23_value.append(current_eye_height_phase23_value.copy())

                if current_eye_height_l0_value:
                    total_eye_height_l0_value.append(current_eye_height_l0_value.copy())

                current_ltssm_group.clear()
                current_0x20560.clear()
                current_0x10198.clear()
                current_gen5_preset.clear()
                current_speed.clear()
                current_ltssm.clear()
                ...
                current_eye_height_phase23_value.clear()
                current_eye_height_l0_value.clear()
    ...
    sheet.cell(row=excel_row, column=excel_column, value="lane coefs")

    for (sub_ltssm_group, sub_0x20560, sub_0x10198, sub_gen5_preset, sub_speed, sub_ltssm, sub_ltssm_st_value,
         sub_histogram_data,
         sub_histogram_data2_height, sub_eq_obj_value, sub_eq_obj_tap4_value,
         sub_eq_obj_tap5_value, sub_eq_obj_tap6_value, sub_eq_obj_ffe_taps_value,
         sub_eye_height_value, sub_adc_os_cal_dig_cor_gen_value,
         sub_adc_os_cal_actl_gen_value, sub_take_it_out_value,
         sub_take_it_out_early_value, sub_eye_height_phase23_value, sub_eye_height_l0_value) \
            in itertools.zip_longest(total_ltssm_group, total_0x20560, total_0x10198, total_gen5_preset, total_speed,
                                     total_ltssm, total_ltssm_st_value,
                                     ...
                                     total_adc_os_cal_dig_cor_gen_value, total_adc_os_cal_actl_gen_value,
                                     total_take_it_out_value,
                                     total_take_it_out_early_value, total_eye_height_phase23_value,
                                     total_eye_height_l0_value):
...
def test():
    ...
    # file_path = preprocess_log(r"E:\files\phytium\TS\log\nicX1-10times.log", begin_str,                               end_str)
    # print(file_path)
